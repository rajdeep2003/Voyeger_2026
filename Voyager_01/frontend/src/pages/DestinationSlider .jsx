...
//     <div className="mb-16">
//       <h2 className="mb-10 font-serif text-3xl font-bold text-gray-900">{title}</h2>
...
//             >
//               <div className="overflow-hidden transition-all duration-300 ease-out bg-white border border-gray-200 shadow-lg rounded-xl hover:shadow-2xl hover:border-gray-300 hover:-translate-y-1">
...
//                 </div>
//                 <div className="p-5">
//                   <h3 className="mb-1 font-sans text-xl font-bold text-gray-800">{destination.name}</h3>
//                   <p className="text-sm text-gray-600">{destination.state || destination.country || "Beautiful Destination"}</p>
//                 </div>
//               </div>
//             </div>
//           ))}
...
//         <button
//           onClick={prev}
//           className="absolute left-0 z-10 p-2 transition-all duration-200 -translate-x-2 -translate-y-1/2 border border-gray-200 rounded-full shadow-md top-1/2 bg-white/90 hover:bg-white hover:shadow-lg"
//           aria-label="Previous"
//         >
...
//         <button
//           onClick={next}
//           className="absolute right-0 z-10 p-2 transition-all duration-200 translate-x-2 -translate-y-1/2 border border-gray-200 rounded-full shadow-md top-1/2 bg-white/90 hover:bg-white hover:shadow-lg"
//           aria-label="Next"
//         >
...
const DestinationSlider = () => {
  ...
  const renderSlider = (items, index, next, prev, titleKey) => (
    <div className="mb-16">
      <h2 className="mb-10 font-serif text-3xl font-bold text-gray-900">{t(titleKey)}</h2>
      <div className="relative overflow-hidden">
        <div
          className={`flex gap-8 ${isTransitioning ? 'transition-transform duration-500 ease-in-out' : ''}`}
          style={{ transform: `translateX(-${index * 300}px)` }}
          ...
          {items.map((destination, i) => (
            ...
            >
              <div className="overflow-hidden transition-all duration-300 ease-out bg-white border border-gray-200 shadow-lg rounded-xl hover:shadow-2xl hover:border-gray-300 hover:-translate-y-1">
                ...
                <div className="p-5">
                  <h3 className="mb-1 font-sans text-xl font-bold text-gray-800">{destination.name}</h3>
                  <p className="text-sm text-gray-600">{t('destinationSlider.defaultDescription')}</p>
                </div>
              </div>
            </div>
          ))}
